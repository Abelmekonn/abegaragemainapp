...
function CustomerSearch({ onSelectCustomer }) { // Add onSelectCustomer prop
    ...
    const handleSelectCustomer = (customerId) => {
        onSelectCustomer(customerId); // Call the prop function with the selected customer ID
    };
    ...
    return (
        <div>
            ...
            {searchTerm !== '' ? (
                <div className="link-btn mt-3 d-none">
                <Link to="/admin/add-customer" className="theme-btn btn-style-one" >Add new customer</Link>
            </div>
            ) : (
