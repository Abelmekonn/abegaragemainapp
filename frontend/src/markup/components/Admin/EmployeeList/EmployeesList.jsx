                ...
                <tbody>
                  {employees.map((employee) => (
                    <tr key={employee.employee_id}>
                      ...
                      <td>
                        <div className="edit">
                          <a onClick={() => handleEditEmployee(employee.employee_id)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
